...
class ResNet18(models.ResNet):
    ...
    def init(self, model_dir=None, gain=1.):
        ...
        # if 'meta' in self.model_dir:
        #     sd = torch.load(self.model_dir)
        # else:
        ...
        # for k, v in sd.items():
        #     print(k)
        #     if k.startswith('stem') or k.startswith('conv1d'):
        #         del_list.append(k)
        #
...
class ResNet34(models.ResNet):
    ...
    def __init__(self, in_channels, num_classes=10, **kwargs):
        Block = BasicBlock
        super(ResNet34, self).__init__(Block, [3, 4, 6, 3], num_classes=num_classes, **kwargs)    # resnet18
